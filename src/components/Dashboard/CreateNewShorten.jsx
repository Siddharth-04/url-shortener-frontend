    ...
    return (
        <div className='flex justify-center items-center bg-white rounded-md '>
            ...
            >
                ...
                <button
                    className=' font-semibold text-white w-32 bg-blue-500 py-2 transition-colors rounded-md my-3 hover:bg-blue-600 disabled:bg-blue-300 hover:cursor-pointer'
                    type='text'
                >
